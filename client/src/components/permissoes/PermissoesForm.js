...
import {permissoesNovo} from './PermissoesFunctions'
...
class RecursoForm extends Component {
    ...
    onSubmit(e){
        ...
        if(this.validateForm()) {
            ...
            permissoesNovo(this.state.fields).then(res => {           
                 this.props.history.push('/permissoes')    
             })
                            ...
                            <section className="content container" >
                                ...
                                <div className="box box-primary " style={{width:'95%'}} >
                                    <div className="box-header with-border">
                                        <h3 className="box-title">Informe os dados de Permissões</h3>
                                    </div>
                                    ...
                                    <form noValidate onSubmit={this.onSubmit}  >
                                        ...
                                        <div className="box-footer ">
                                            ...
                                            <a href="/permissoes" className="btn btn-danger">Cancelar</a>
                                        </div>
                                    </form>
                                </div>
