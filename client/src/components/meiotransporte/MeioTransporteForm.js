...
import {meiotransporteNovo} from './MeioTransporteFunctions'
...
class RecursoForm extends Component {
    ...
    validateForm(){
        ...
        if (!fields["nome"]) {
            formIsValid = false            
            errors["nome"] = "Por Favor, Informe o Meio de Transporte."
    ...
    onSubmit(e){
        ...
        if(this.validateForm()) {
            ...
            meiotransporteNovo(this.state.fields).then(res => {           
                 this.props.history.push('/meiotransportes')    
             })
                    ...
                    <div className="wrapper">
                        ...
                        <div className="content-wrapper"   >
                            ...
                            <section className="content-header">
                                ...
                                <li><a href="/meiotransportes">Modalidades</a></li>
                            ...
                            <section className="content container" >
                                ...
                                <div className="box box-primary " style={{width:'95%'}} >
                                    <div className="box-header with-border">
                                        <h3 className="box-title">Informe os dados Meio de Transporte</h3>
                                    </div>
                                    ...
                                    <form noValidate onSubmit={this.onSubmit}  >
                                        <div className="box-body  ">
                                            <div className={ errors.nome !== undefined ?  "form-group has-error": "form-group "}>
                                                ...
                                                placeholder="Informe o Meio de Transporte"
                                                id="nome" 
                                                name="nome"
                                        ...
                                        <div className="box-footer ">
                                            ...
                                            <a href="/meiotransportes" className="btn btn-danger">Cancelar</a>
                                        </div>
                                    </form>
                                </div>
