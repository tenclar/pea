...
import {modalidadeNovo} from './ModalidadeFunctions'
...
class RecursoForm extends Component {
    ...
    onSubmit(e){
        ...
        if(this.validateForm()) {
            ...
            modalidadeNovo(this.state.fields).then(res => {           
                            ...
                            <section className="content container" >
                                ...
                                <div className="box box-primary " style={{width:'95%'}} >
                                    <div className="box-header with-border">
                                        <h3 className="box-title">Informe os dados da Modalidade</h3>
                                    </div>
                                    ...
                                    <form noValidate onSubmit={this.onSubmit}  >
                                        ...
                                        <div className="box-footer ">
                                            ...
                                            <a href="/modalidades" className="btn btn-danger">Cancelar</a>
                                        </div>
                                    </form>
                                </div>
